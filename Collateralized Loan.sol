...
contract CollateralizedLoan {
    ...
    modifier loanExists(uint _loanId) {
        require(_loanId < nextLoanId, "Loan record does not exist.");
        _;
    }
    ...
    function depositCollateralAndRequestLoan(uint _interestRate, uint _duration) external payable {
        ...
        // Loan amount is strictly 50% of the collateral (Over-collateralized)
    ...
    // 3. REPAY A LOAN (With Early Repayment Rebate Logic)
    ...
    // 4. CLAIM COLLATERAL (In Case of Default)
